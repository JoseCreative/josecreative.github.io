...
<div class="AspNet-Login">
			...
			<div id="ctl00_cphRoblox_pFigure">
				...
				<div id="Figure"><a id="ctl00_cphRoblox_ImageFigure" disabled="disabled" title="Figure" onclick="return false" style="display:inline-block;"><img src="./assets/images/av_load.png" border="0" id="img" alt="Figure" blankurl="http://t1.roblox.com:80/blank-115x130.gif" width=300% height=300% /></a></div>

</div>

		</div>
		<div id="RobloxAtAGlance">
			<h2>ROBLOX 2D demake</h2>
			<h3>ROBLOX 2D is free!</h3>
			<ul id="ThingsToDo">
				<li id="Point1">
					<h3>Build your own personal Place</h3>
			...
			<div id="Showcase">
				<iframe id="embedplayer" src="http://www.bitview.net/embed.php?v=wNat_zmv70P" width="400" height="340" allowfullscreen scrolling="true" frameborder="4"></iframe>
			</div>
			<div id="Install">
				<div id="CompatibilityNote"><div id="ctl00_cphRoblox_pCompatibilityNote">
	Works with your<br/>Windows PC!
</div></div>
				<div id="DownloadAndPlay"><a id="ctl00_cphRoblox_hlDownloadAndPlay" href="Login/New.aspx?ReturnUrl=%2fGames.aspx"><img src="./assets/images/downloadbtn.png" alt="FREE - Download and Play!" border="0"/></a></div>
			</div>

<input type="hidden" name="__VIEWSTATEENCRYPTED" id="__VIEWSTATEENCRYPTED" value=""/>
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="aJECwRyd8P5ZCPYQkpf+VUJIfih6WYREyt3hLS0lmkiBeRd8PEWRgk+Dfwj4nuYw"/>
